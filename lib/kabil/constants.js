...
export const PIPELINE_BUCKETS = [
  { bucket: "sourcing", label: "Sourcing", accent: "#1f9d57" },
  { bucket: "screening", label: "Screening", accent: "#c9a23f" },
  { bucket: "interview", label: "Interview", accent: "#2f7fd1" },
  { bucket: "final_shortlist", label: "Final Shortlist", accent: "#8155c9" },
];
